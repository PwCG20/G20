...
export default {
  ...
  methods: {
    ...
    setCompanyPD () {
      ...
      if (document.getElementById("chartCompanyPD") == undefined) {
        setTimeout(function () {
          _this.setCompanyPD();
        }, 2000);
        return;
      ...
      _this.mychartList["chartCompanyPD"] = myChart;
      myChart.showLoading({
        text: "loading...",
      });
  ...
  mounted () {
    ...
    window.addEventListener("resize", () => {
      if (_this.mychartList["chartCompanyPD"] != undefined)
        _this.mychartList["chartCompanyPD"].resize();
    });
  },
  computed: {},
  created () { },
...
.process3 .content-chart-item {
  border: 1px solid #dcdcdc;
  margin: 5px -3px 5px 7px;
}
.process3 .company-info span {
  font-size: 19px !important;
  color: #d04a02;
}

.process3 .chart-canvas {
  height: 600px;
